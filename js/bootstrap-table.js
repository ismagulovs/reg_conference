...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s записей на станице', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Показаны с %s по %s из %s строк', pageFrom, pageTo, totalRows);
        },
        ...
        if (this.options.showColumns) {
            ...
            $.each(this.options.columns, function (i, column) {
                ...
                if (column.switchable) {
                    ...
                    '<label><input type="checkbox" id="fields%s" data-field="%s" value="%s"%s> %s</label>' +
                    '</li>',i, column.field, i, checked, column.title));
                    switchableCount++;
                }
            });
            html.push('</ul>',
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                    ...
                    text = ['<td class="bs-checkbox">',
                        ...
                        sprintf(' id="ch%s"', item[that.options.idField]) +
